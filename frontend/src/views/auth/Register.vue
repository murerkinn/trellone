    ...
    a-col(:span="7")
      a-card
        a-form(:form="form" @submit="register")
          ...
          a-form-item
            a-input(placeholder="Name" v-decorator="validationRules.name")
          a-form-item
          ...
          a-form-item
            a-input(type="password" placeholder="Confirm password" v-decorator="validationRules.passwordConfirmation" @blur="handleConfirmBlur")
          ...
          a-form-item
            center Already have an account? <router-link to="/login">Log in</router-link>
</template>
